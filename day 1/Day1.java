...
public class Day1 {
    public static void main(String[] args) throws IOException {
        BufferedReader input = new BufferedReader(new FileReader("C:/Users/Alexis/dev/adventofcode/day 1/input.txt"));
        System.out.println(countDepthIncrease(input));
        input = new BufferedReader(new FileReader("C:/Users/Alexis/dev/adventofcode/day 1/input.txt"));
